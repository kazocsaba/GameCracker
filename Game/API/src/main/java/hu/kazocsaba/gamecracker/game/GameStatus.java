...
/**
 * The status of a game in a certain position. In final positions, it represents the outcome; otherwise it represents the
 * player to move.
 *
 * @author Kazó Csaba
 */
public enum GameStatus {
	 ...
	 * 
	 * @return {@code Player.WHITE} if this status is {@code WHITE_MOVES}, and {@code Player.BLACK} if this status is
	 * {@code BLACK_MOVES}
	...
	/**
	 * Returns the winner player, or {@code null} is the outcome is a draw.
	 * Throws an exception if this status is not final.
	 * 
	 * @return {@code Player.WHITE} if this status is {@code WHITE_WINS}, {@code Player.BLACK} if this status is
	 * {@code BLACK_WINS}, and {@code null} if this status is {@code DRAW}
