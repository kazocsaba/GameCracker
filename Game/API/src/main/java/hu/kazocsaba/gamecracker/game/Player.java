...
/**
 * A player of a game. The two players are called White and Black. Usually, but not necessarily,
 * White is the player with the first move.
 *
 * @author Kazó Csaba
 */
public enum Player {
   ...
   *
   * @return {@code GameStatus.WHITE_WINS} if this player is White, and
   * {@code GameStatus.BLACK_WINS} if this player is Black
   */
   ...
   *
   * @return {@code GameStatus.WHITE_MOVES} if this player is White, and
   * {@code GameStatus.BLACK_MOVES} if this player is Black
   */
