 ...
 * @author Kazó Csaba
 */
public abstract class Reversi<P extends ReversiPosition<P, M>, M extends ReversiMove<M>>
    extends Game<P, M, SwitchableSquareSymmetry> {
  ...
  /**
   * Parses strings in the form of 'b1' or 'a3'. The first character identifies the column starting
   * from 'a', and the second character identifies the row starting from '1'.
   *
