...
public class Reversi6Position extends ReversiPosition<Reversi6Position, Reversi6Move> {
	static final PositionSerializer<Reversi6Position> SERIALIZER=new PositionSerializer<Reversi6Position>() {
	...
	static final CategoryFunction<Reversi6Position> CATEGORY_FUNCTION=new CategoryFunction<Reversi6Position>() {
