...
/**
 * The result of a node in the game graph. This enumeration describes our knowledge of the result of
 * game positions (assuming perfect play) based on the current graph.
 *
 * @author Kazó Csaba
 */
public enum GraphResult {
  ...
  /**
   * Returns either {@code WHITE_WINS}, {@code BLACK_WINS}, or {@code DRAW}, based on the value of
   * {@code gameStatus}.
   *
   ...
   *
   * @param player a player
   * @return {@code WHITE_WONT_WIN} if the player is White, {@code BLACK_WONT_WIN} if the player is
   * Black
   */
   ...
   *
   * @param player a player
   * @return {@code true} if the specified player definitely wins from this state, {@code false}
   * otherwise
   */
   ...
   *
   * @param player a player
   * @return {@code true} if it is possible that the specified player will win, {@code false} if
   * {@code player} cannot win
   */
   ...
   *
   * @return {@code true} if the result is known (i.e. it is either {@code WHITE_WINS},
  ...
  /**
   * Returns either {@code GameStatus.WHITE_WINS}, {@code GameStatus.BLACK_WINS}, or
   * {@code GameStatus.DRAW}, based on the value of this result.
   *
   * @return the result
