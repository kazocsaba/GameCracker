...
class MemoryNormalNode<P extends Position<P,M,T>, M extends Move<M,T>, T extends Transformation<T>> extends MemoryNode<P,M,T> {
	...
	private static <P extends Position<P,M,T>, M extends Move<M,T>, T extends Transformation<T>> void recomputeResult(MemoryNode<P,M,T> node) {
	...
	private static <P extends Position<P,M,T>, M extends Move<M,T>, T extends Transformation<T>> void recomputeResults(List<MemoryNode<P,M,T>> nodes) {
		do {
